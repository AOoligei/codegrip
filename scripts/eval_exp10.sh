#!/bin/bash
# Evaluate Exp 10 (TGS + graph prompt, Idea K+L combined)
# Usage: bash scripts/eval_exp10.sh [gpu_id]
...
# Step 1: Evaluate with GRAPH prompt (matches training format)
...
# Also eval with filetree mode for comparison
...
# Step 2: Expansion on graph-mode predictions
PRED_DIR="eval_graph"
